...
import './KYCFaceVerification.css';
...
const KYCFaceVerification = () => {
  ...
  const handleVerify = async (imageFile = null) => {
    ...
    try {
      ...
      console.log('Starting KYC Verification:', {
        ...
        endpoint: 'KYC Face Verification'
      });
      
      // Call KYC verification API with correct endpoint
      // Endpoint: BASE_URL/api/v1/third-party/verification/base_64/verification/kyc/face
      const response = await kycFaceVerification({
        baseUrl: baseUrl,
  ...
  return (
    <div className="kyc-verification">
      <div className="card">
        <h2>KYC Face Verification</h2>
        <p className="description">
          Verify your identity using your Ghana card (number or image) and a face image. Prefer a live selfie.
